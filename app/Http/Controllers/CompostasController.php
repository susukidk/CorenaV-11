  ...
  public function pdf($folioCompostas)
{
    ...
    // Cargar la vista que será convertida en PDF
    $pdf = \PDF::loadView('compostas.pdf', compact('composta', 'alcaldias'));
    
    // Mostrar el PDF en el navegador (puedes cambiar esto a ->download si prefieres que se descargue)
    return $pdf->stream('composta_'.$folioCompostas.'.pdf');
}

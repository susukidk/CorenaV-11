...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/mecanizacion/mecanizacionpdf/{folioMecanizacion}', [MecanizacionController::class, 'mecanizacionpdf'])->name('mecanizacion.mecanizacionpdf');
    ...
    Route::get('/arbolesfrutales/arbolesfrutalespdf/{folioarbolesfrutales}', [ArbolesFrutalesController::class, 'arbolesfrutalespdf'])->name('arbolesfrutales.arbolesfrutalespdf');
});
